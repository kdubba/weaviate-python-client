...
class Schema:
    ...
    def create_class_tenants(self, class_name: str, tenants: Union[dict, str]) -> None:
        ...
        self._create_class_tenants(class_name, loaded_tenants)

    def _create_class_tenants(self, class_name: str, tenants: dict) -> None:
        """
        Create classes tenants.

        Parameters
        ----------
        tenants : dict
            An array of Weaviate tenants.
